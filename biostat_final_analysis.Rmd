---
title: "biostat_final_data_analysis"
...
p-value < 0.05
5.445521e-09 < 0.05, we reject the null hypothesis, which states that the
mean growth of ovx and sham group are the same.
...
states that the mean growth for the ovx and sham groups of anoles is the same,
and conclude H_a, which states that the mean growth in mm ofr ovx group is
